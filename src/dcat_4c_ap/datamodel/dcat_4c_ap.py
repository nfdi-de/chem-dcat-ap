...
# Generation date: 2025-04-07T12:13:23
# Schema: dcat-4C-ap
#
...
class ChemicalEntity(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.iupac_formula is not None and not isinstance(
            self.iupac_formula, IUPACChemicalFormula
        ):
...
class EvaluatedEntity(YAMLRoot):
    ...
    was_generated_by: Optional[
        Union[Union[dict, "Activity"], List[Union[dict, "Activity"]]]
    ] = empty_list()
    type: Optional[Union[dict, DefinedTerm]] = None
    rdf_type: Optional[Union[dict, DefinedTerm]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.has_part is not None and not isinstance(
            self.has_part, EvaluatedEntityId
        ):
            self.has_part = EvaluatedEntityId(self.has_part)

        if not isinstance(self.was_generated_by, list):
            self.was_generated_by = (
                [self.was_generated_by] if self.was_generated_by is not None else []
            )
        self.was_generated_by = [
            v if isinstance(v, Activity) else Activity(**as_dict(v))
            for v in self.was_generated_by
        ]
...
class ChemicalSubstance(EvaluatedEntity):
    ...
    composed_of: Optional[
        Union[Union[dict, ChemicalEntity], List[Union[dict, ChemicalEntity]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.composed_of, list):
            self.composed_of = (
                [self.composed_of] if self.composed_of is not None else []
            )
        self.composed_of = [
            v if isinstance(v, ChemicalEntity) else ChemicalEntity(**as_dict(v))
            for v in self.composed_of
        ]
...
class AnalysisSourceData(EvaluatedEntity):
    ...
    was_generated_by: Optional[
        Union[
            Union[dict, "DataCreatingActivity"],
            List[Union[dict, "DataCreatingActivity"]],
        ]
    ] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.was_generated_by = [
            v
            if isinstance(v, DataCreatingActivity)
            else DataCreatingActivity(**as_dict(v))
            for v in self.was_generated_by
        ]
...
class NMRSpectrum(AnalysisSourceData):
    ...
    was_generated_by: Optional[
        Union[Union[dict, "NMRSpectroscopy"], List[Union[dict, "NMRSpectroscopy"]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.was_generated_by = [
            v if isinstance(v, NMRSpectroscopy) else NMRSpectroscopy(**as_dict(v))
            for v in self.was_generated_by
        ]
...
class Tool(YAMLRoot):
    ...
    has_part: Optional[Union[Union[dict, "Tool"], List[Union[dict, "Tool"]]]] = (
        empty_list()
    )
    type: Optional[Union[dict, DefinedTerm]] = None
    rdf_type: Optional[Union[dict, DefinedTerm]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.has_part = [
            v if isinstance(v, Tool) else Tool(**as_dict(v)) for v in self.has_part
        ]
...
class DataCreatingActivity(Activity):
    ...
    used_tool: Optional[Union[Union[dict, Tool], List[Union[dict, Tool]]]] = (
        empty_list()
    )
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.used_tool = [
            v if isinstance(v, Tool) else Tool(**as_dict(v)) for v in self.used_tool
        ]
...
class NMRSpectroscopy(DataCreatingActivity):
    ...
    evaluated_entity: Optional[
        Union[
            Dict[Union[str, ChemicalSampleId], Union[dict, ChemicalSample]],
            List[Union[dict, ChemicalSample]],
        ]
    ] = empty_dict()
    rdf_type: Optional[Union[dict, DefinedTerm]] = None
...
class NMRSpectralAnalysis(DataAnalysis):
    ...
    evaluated_entity: Optional[
        Union[
            Dict[Union[str, NMRSpectrumId], Union[dict, NMRSpectrum]],
            List[Union[dict, NMRSpectrum]],
        ]
    ] = empty_dict()
...
class EvaluatedActivity(Activity):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.has_part is not None and not isinstance(
            self.has_part, EvaluatedActivityId
        ):
...
class Catalogue(YAMLRoot):
    ...
    applicable_legislation: Optional[
        Union[Union[dict, "LegalResource"], List[Union[dict, "LegalResource"]]]
    ] = empty_list()
    catalogue: Optional[
    ...
    has_dataset: Optional[
        Union[Union[dict, "Dataset"], List[Union[dict, "Dataset"]]]
    ] = empty_list()
    has_part: Optional[
        Union[Union[dict, "Catalogue"], List[Union[dict, "Catalogue"]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.applicable_legislation, list):
            self.applicable_legislation = (
                [self.applicable_legislation]
                if self.applicable_legislation is not None
                else []
            )
        self.applicable_legislation = [
            v if isinstance(v, LegalResource) else LegalResource(**as_dict(v))
            for v in self.applicable_legislation
        ]
        ...
        if not isinstance(self.has_dataset, list):
            self.has_dataset = (
                [self.has_dataset] if self.has_dataset is not None else []
            )
        self.has_dataset = [
            v if isinstance(v, Dataset) else Dataset(**as_dict(v))
            for v in self.has_dataset
        ]
...
class ResearchCatalog(Catalogue):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.has_dataset is not None and not isinstance(
            self.has_dataset, ResearchDatasetId
        ):
...
class DataService(YAMLRoot):
    ...
    documentation: Optional[
        Union[Union[dict, "Document"], List[Union[dict, "Document"]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.endpoint_URL, list):
            self.endpoint_URL = (
                [self.endpoint_URL] if self.endpoint_URL is not None else []
            )
        self.endpoint_URL = [
            v if isinstance(v, Resource) else Resource(**as_dict(v))
            for v in self.endpoint_URL
        ]
        ...
        if not isinstance(self.documentation, list):
            self.documentation = (
                [self.documentation] if self.documentation is not None else []
            )
        self.documentation = [
            v if isinstance(v, Document) else Document(**as_dict(v))
        ...
        self.endpoint_description = [
            v if isinstance(v, Resource) else Resource(**as_dict(v))
            for v in self.endpoint_description
        ]
        ...
        if not isinstance(self.landing_page, list):
            self.landing_page = (
                [self.landing_page] if self.landing_page is not None else []
            )
        self.landing_page = [
            v if isinstance(v, Document) else Document(**as_dict(v))
            for v in self.landing_page
        ]
        ...
        if not isinstance(self.serves_dataset, list):
            self.serves_dataset = (
                [self.serves_dataset] if self.serves_dataset is not None else []
            )
        self.serves_dataset = [
            v if isinstance(v, Dataset) else Dataset(**as_dict(v))
            for v in self.serves_dataset
        ]
...
class Dataset(YAMLRoot):
    ...
    source: Optional[Union[Union[dict, "Dataset"], List[Union[dict, "Dataset"]]]] = (
        empty_list()
    )
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.has_version, list):
            self.has_version = (
                [self.has_version] if self.has_version is not None else []
            )
        self.has_version = [
            v if isinstance(v, Dataset) else Dataset(**as_dict(v))
            for v in self.has_version
        ]
        ...
        if not isinstance(self.is_referenced_by, list):
            self.is_referenced_by = (
                [self.is_referenced_by] if self.is_referenced_by is not None else []
            )
        self.is_referenced_by = [
            v if isinstance(v, Resource) else Resource(**as_dict(v))
            for v in self.is_referenced_by
        ]
        ...
        self.source = [
            v if isinstance(v, Dataset) else Dataset(**as_dict(v)) for v in self.source
        ]
...
class ResearchDataset(Dataset):
    ...
    was_generated_by: Union[
        Union[dict, DataCreatingActivity], List[Union[dict, DataCreatingActivity]]
    ] = None
    describes_entity: Optional[
        Union[
            Dict[Union[str, EvaluatedEntityId], Union[dict, EvaluatedEntity]],
            List[Union[dict, EvaluatedEntity]],
        ]
    ] = empty_dict()
    describes_activity: Optional[
        Union[
            Dict[Union[str, EvaluatedActivityId], Union[dict, EvaluatedActivity]],
            List[Union[dict, EvaluatedActivity]],
        ]
...
class AnalysisDataset(ResearchDataset):
    ...
    title: Union[str, List[str]] = None
    was_generated_by: Union[
        Union[dict, DataAnalysis], List[Union[dict, DataAnalysis]]
    ] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.was_generated_by = [
            v if isinstance(v, DataAnalysis) else DataAnalysis(**as_dict(v))
            for v in self.was_generated_by
        ]
...
class NMRAnalysisDataset(AnalysisDataset):
    ...
    title: Union[str, List[str]] = None
    was_generated_by: Optional[
        Union[Union[dict, NMRSpectralAnalysis], List[Union[dict, NMRSpectralAnalysis]]]
    ] = empty_list()
    describes_entity: Optional[
        Union[
            Dict[Union[str, ChemicalSampleId], Union[dict, ChemicalSample]],
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.was_generated_by = [
            v
            if isinstance(v, NMRSpectralAnalysis)
            else NMRSpectralAnalysis(**as_dict(v))
            for v in self.was_generated_by
        ]
...
class Distribution(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.download_URL, list):
            self.download_URL = (
                [self.download_URL] if self.download_URL is not None else []
            )
        self.download_URL = [
            v if isinstance(v, Resource) else Resource(**as_dict(v))
            for v in self.download_URL
        ]
...
class DatasetThemes(EnumDefinitionImpl):
    Energy = PermissibleValue(text="Energy", meaning=None)
    Environment = PermissibleValue(text="Environment", meaning=None)
    Health = PermissibleValue(text="Health", meaning=None)
    Transport = PermissibleValue(text="Transport", meaning=None)
    ...
    def _addvals(cls):
        setattr(
            ...
            PermissibleValue(
                text="Agriculture, fisheries, forestry and food", meaning=None
            ),
        )
        setattr(
            cls,
            "Economy and finance",
            PermissibleValue(text="Economy and finance", meaning=None),
        )
        setattr(
            cls,
            "Education, culture and sport",
            PermissibleValue(text="Education, culture and sport", meaning=None),
        )
        setattr(
            cls,
            "Government and public sector",
            PermissibleValue(text="Government and public sector", meaning=None),
        )
        setattr(
            cls,
            "International issues",
            PermissibleValue(text="International issues", meaning=None),
        )
        setattr(
            cls,
            "Justice, legal system and public safety",
            PermissibleValue(
                text="Justice, legal system and public safety", meaning=None
            ),
        )
        setattr(
            cls,
            "Provisional data",
            PermissibleValue(text="Provisional data", meaning=None),
        )
        setattr(
            cls,
            "Regions and cities",
            PermissibleValue(text="Regions and cities", meaning=None),
        )
        setattr(
            cls,
            "Population and society",
            PermissibleValue(text="Population and society", meaning=None),
        )
        setattr(
            cls,
            "Science and technology",
            PermissibleValue(text="Science and technology", meaning=None),
        )
...
slots.has_role = Slot(
    uri=NFDI4C.has_role,
    name="has_role",
    curie=NFDI4C.curie("has_role"),
    model_uri=NFDI4C.has_role,
    domain=None,
    range=Optional[str],
)
...
slots.evaluated_entity = Slot(
    ...
    model_uri=NFDI4C.evaluated_entity,
    domain=None,
    range=Optional[
        Union[
            Dict[Union[str, EvaluatedEntityId], Union[dict, EvaluatedEntity]],
...
slots.evaluated_activity = Slot(
    ...
    model_uri=NFDI4C.evaluated_activity,
    domain=None,
    range=Optional[
        Union[
            Dict[Union[str, EvaluatedActivityId], Union[dict, EvaluatedActivity]],
...
slots.used_tool = Slot(
    uri=PROV.used,
    name="used_tool",
    curie=PROV.curie("used"),
    model_uri=NFDI4C.used_tool,
    domain=None,
    range=Optional[Union[Union[dict, Tool], List[Union[dict, Tool]]]],
)
...
slots.realized_plan = Slot(
    ...
    name="realized_plan",
    curie=PROV.curie("used"),
    model_uri=NFDI4C.realized_plan,
    domain=None,
...
slots.occurred_in = Slot(
    uri=BFO["0000066"],
    name="occurred_in",
    curie=BFO.curie("0000066"),
    model_uri=NFDI4C.occurred_in,
    domain=None,
    range=Optional[Union[dict, Environment]],
)
...
slots.has_qualitative_attribute = Slot(
    ...
    model_uri=NFDI4C.has_qualitative_attribute,
    domain=None,
    range=Optional[
        Union[
            Union[dict, QualitativeAttribute], List[Union[dict, QualitativeAttribute]]
...
slots.has_quantitative_attribute = Slot(
    ...
    curie=DCTERMS.curie("relation"),
    model_uri=NFDI4C.has_quantitative_attribute,
    domain=None,
    range=Optional[
        Union[
            Union[dict, QuantitativeAttribute], List[Union[dict, QuantitativeAttribute]]
...
slots.value = Slot(
    ...
    model_uri=NFDI4C.value,
    domain=None,
    range=Optional[str],
)

slots.describes_entity = Slot(
    uri=DCTERMS.relation,
    name="describes_entity",
    curie=DCTERMS.curie("relation"),
    model_uri=NFDI4C.describes_entity,
    domain=None,
    range=Optional[
        Union[
            Dict[Union[str, EvaluatedEntityId], Union[dict, EvaluatedEntity]],
...
slots.describes_activity = Slot(
    uri=DCTERMS.relation,
    name="describes_activity",
    curie=DCTERMS.curie("relation"),
    model_uri=NFDI4C.describes_activity,
    domain=None,
    range=Optional[
        Union[
            Dict[Union[str, EvaluatedActivityId], Union[dict, EvaluatedActivity]],
...
slots.access_rights = Slot(
    ...
    model_uri=NFDI4C.access_rights,
    domain=None,
    range=Optional[str],
)
...
slots.access_service = Slot(
    ...
    model_uri=NFDI4C.access_service,
    domain=None,
    range=Optional[str],
)
...
slots.applicable_legislation = Slot(
    ...
    model_uri=NFDI4C.applicable_legislation,
    domain=None,
    range=Optional[str],
)
...
slots.application_profile = Slot(
    ...
    model_uri=NFDI4C.application_profile,
    domain=None,
    range=Optional[str],
)
...
slots.checksum_value = Slot(
    ...
    model_uri=NFDI4C.checksum_value,
    domain=None,
    range=Optional[str],
)
...
slots.compression_format = Slot(
    ...
    model_uri=NFDI4C.compression_format,
    domain=None,
    range=Optional[str],
)
...
slots.contact_point = Slot(
    ...
    model_uri=NFDI4C.contact_point,
    domain=None,
    range=Optional[str],
)
...
slots.dataset_distribution = Slot(
    ...
    model_uri=NFDI4C.dataset_distribution,
    domain=None,
    range=Optional[str],
)
...
slots.documentation = Slot(
    ...
    model_uri=NFDI4C.documentation,
    domain=None,
    range=Optional[str],
)
...
slots.endpoint_description = Slot(
    ...
    model_uri=NFDI4C.endpoint_description,
    domain=None,
    range=Optional[str],
)
...
slots.geographical_coverage = Slot(
    ...
    model_uri=NFDI4C.geographical_coverage,
    domain=None,
    range=Optional[str],
)
...
slots.is_referenced_by = Slot(
    ...
    model_uri=NFDI4C.is_referenced_by,
    domain=None,
    range=Optional[str],
)
...
slots.linked_schemas = Slot(
    ...
    name="linked_schemas",
    curie=DCTERMS.curie("conformsTo"),
    model_uri=NFDI4C.linked_schemas,
    domain=None,
    range=Optional[str],
)
...
slots.modification_date = Slot(
    ...
    model_uri=NFDI4C.modification_date,
    domain=None,
    range=Optional[str],
)
...
slots.other_identifier = Slot(
    ...
    model_uri=NFDI4C.other_identifier,
    domain=None,
    range=Optional[str],
)
...
slots.packaging_format = Slot(
    ...
    model_uri=NFDI4C.packaging_format,
    domain=None,
    range=Optional[str],
)
...
slots.preferred_label = Slot(
    ...
    model_uri=NFDI4C.preferred_label,
    domain=None,
    range=Optional[str],
)
...
slots.primary_topic = Slot(
    ...
    model_uri=NFDI4C.primary_topic,
    domain=None,
    range=Optional[str],
)
...
slots.qualified_attribution = Slot(
    ...
    model_uri=NFDI4C.qualified_attribution,
    domain=None,
    range=Optional[str],
)
...
slots.qualified_relation = Slot(
    ...
    model_uri=NFDI4C.qualified_relation,
    domain=None,
    range=Optional[str],
)
...
slots.related_resource = Slot(
    ...
    curie=DCTERMS.curie("relation"),
    model_uri=NFDI4C.related_resource,
    domain=None,
    range=Optional[str],
)
...
slots.serves_dataset = Slot(
    ...
    model_uri=NFDI4C.serves_dataset,
    domain=None,
    range=Optional[str],
)
...
slots.source_metadata = Slot(
    ...
    curie=DCTERMS.curie("source"),
    model_uri=NFDI4C.source_metadata,
    domain=None,
    range=Optional[str],
)
...
slots.spatial_resolution = Slot(
    ...
    model_uri=NFDI4C.spatial_resolution,
    domain=None,
    range=Optional[str],
)
...
slots.temporal_coverage = Slot(
    ...
    model_uri=NFDI4C.temporal_coverage,
    domain=None,
    range=Optional[str],
)
...
slots.temporal_resolution = Slot(
    ...
    model_uri=NFDI4C.temporal_resolution,
    domain=None,
    range=Optional[str],
)
...
slots.version_notes = Slot(
    ...
    model_uri=NFDI4C.version_notes,
    domain=None,
    range=Optional[str],
)
...
slots.was_generated_by = Slot(
    ...
    model_uri=NFDI4C.was_generated_by,
    domain=None,
    range=Optional[str],
)

slots.chemicalSubstance__composed_of = Slot(
    uri=NFDI4C.composed_of,
    name="chemicalSubstance__composed_of",
    curie=NFDI4C.curie("composed_of"),
    model_uri=NFDI4C.chemicalSubstance__composed_of,
    domain=None,
    range=Optional[
        Union[Union[dict, ChemicalEntity], List[Union[dict, ChemicalEntity]]]
    ],
...
slots.chemicalEntity__inchi = Slot(
    uri=NFDI4C.inchi,
    name="chemicalEntity__inchi",
    curie=NFDI4C.curie("inchi"),
    model_uri=NFDI4C.chemicalEntity__inchi,
    domain=None,
    range=Optional[Union[dict, InChi]],
)

slots.chemicalEntity__inchikey = Slot(
    uri=NFDI4C.inchikey,
    name="chemicalEntity__inchikey",
    curie=NFDI4C.curie("inchikey"),
    model_uri=NFDI4C.chemicalEntity__inchikey,
    domain=None,
    range=Optional[Union[dict, InChIKey]],
)

slots.chemicalEntity__smiles = Slot(
    uri=NFDI4C.smiles,
    name="chemicalEntity__smiles",
    curie=NFDI4C.curie("smiles"),
    model_uri=NFDI4C.chemicalEntity__smiles,
    domain=None,
    range=Optional[Union[dict, SMILES]],
)

slots.chemicalEntity__iupac_formula = Slot(
    uri=NFDI4C.iupac_formula,
    name="chemicalEntity__iupac_formula",
    curie=NFDI4C.curie("iupac_formula"),
    model_uri=NFDI4C.chemicalEntity__iupac_formula,
    domain=None,
    range=Optional[Union[dict, IUPACChemicalFormula]],
)
...
slots.definedTerm__from_CV = Slot(
    ...
    model_uri=NFDI4C.definedTerm__from_CV,
    domain=None,
...
slots.quantitativeAttribute__has_quantity_type = Slot(
    ...
    model_uri=NFDI4C.quantitativeAttribute__has_quantity_type,
    domain=None,
...
slots.quantitativeAttribute__unit = Slot(
    ...
    model_uri=NFDI4C.quantitativeAttribute__unit,
    domain=None,
    range=Optional[Union[str, DefinedTermId]],
)

slots.NMRAnalysisDataset_was_generated_by = Slot(
    uri=PROV.wasGeneratedBy,
    name="NMRAnalysisDataset_was_generated_by",
    curie=PROV.curie("wasGeneratedBy"),
    model_uri=NFDI4C.NMRAnalysisDataset_was_generated_by,
    domain=NMRAnalysisDataset,
    range=Optional[
        Union[Union[dict, NMRSpectralAnalysis], List[Union[dict, NMRSpectralAnalysis]]]
    ],
)

slots.NMRAnalysisDataset_describes_entity = Slot(
    uri=DCTERMS.relation,
    name="NMRAnalysisDataset_describes_entity",
    curie=DCTERMS.curie("relation"),
    model_uri=NFDI4C.NMRAnalysisDataset_describes_entity,
    domain=NMRAnalysisDataset,
    range=Optional[
        Union[
            Dict[Union[str, ChemicalSampleId], Union[dict, ChemicalSample]],
...
slots.NMRSpectralAnalysis_evaluated_entity = Slot(
    uri=PROV.used,
    name="NMRSpectralAnalysis_evaluated_entity",
    curie=PROV.curie("used"),
    model_uri=NFDI4C.NMRSpectralAnalysis_evaluated_entity,
    domain=NMRSpectralAnalysis,
    range=Optional[
        Union[
            Dict[Union[str, NMRSpectrumId], Union[dict, NMRSpectrum]],
            List[Union[dict, NMRSpectrum]],
...
slots.NMRSpectroscopy_evaluated_entity = Slot(
    uri=PROV.used,
    name="NMRSpectroscopy_evaluated_entity",
    curie=PROV.curie("used"),
    model_uri=NFDI4C.NMRSpectroscopy_evaluated_entity,
    domain=NMRSpectroscopy,
    range=Optional[
        Union[
            Dict[Union[str, ChemicalSampleId], Union[dict, ChemicalSample]],
            List[Union[dict, ChemicalSample]],
...
slots.NMRSpectroscopy_rdf_type = Slot(
    uri=RDF.type,
    name="NMRSpectroscopy_rdf_type",
    curie=RDF.curie("type"),
    model_uri=NFDI4C.NMRSpectroscopy_rdf_type,
    domain=NMRSpectroscopy,
    range=Optional[Union[dict, DefinedTerm]],
)

slots.NMRSpectrum_was_generated_by = Slot(
    uri=PROV.wasGeneratedBy,
    name="NMRSpectrum_was_generated_by",
    curie=PROV.curie("wasGeneratedBy"),
    model_uri=NFDI4C.NMRSpectrum_was_generated_by,
    domain=NMRSpectrum,
    range=Optional[
        Union[Union[dict, "NMRSpectroscopy"], List[Union[dict, "NMRSpectroscopy"]]]
    ],
...
slots.ClassifierMixin_type = Slot(
    ...
    curie=DCTERMS.curie("type"),
    model_uri=NFDI4C.ClassifierMixin_type,
    domain=None,
    range=Optional[Union[dict, "DefinedTerm"]],
)
...
slots.DefinedTerm_title = Slot(
    ...
    model_uri=NFDI4C.DefinedTerm_title,
    domain=DefinedTerm,
    range=Optional[str],
)

slots.ResearchDataset_was_generated_by = Slot(
    uri=PROV.wasGeneratedBy,
    name="ResearchDataset_was_generated_by",
    curie=PROV.curie("wasGeneratedBy"),
    model_uri=NFDI4C.ResearchDataset_was_generated_by,
    domain=ResearchDataset,
    range=Union[
        Union[dict, DataCreatingActivity], List[Union[dict, DataCreatingActivity]]
    ],
)
...
slots.AnalysisDataset_was_generated_by = Slot(
    ...
    curie=PROV.curie("wasGeneratedBy"),
    model_uri=NFDI4C.AnalysisDataset_was_generated_by,
    domain=AnalysisDataset,
    range=Union[Union[dict, DataAnalysis], List[Union[dict, DataAnalysis]]],
)

slots.ResearchCatalog_has_dataset = Slot(
    uri=DCAT.dataset,
    name="ResearchCatalog_has_dataset",
    curie=DCAT.curie("dataset"),
    model_uri=NFDI4C.ResearchCatalog_has_dataset,
    domain=ResearchCatalog,
    range=Optional[Union[str, ResearchDatasetId]],
)

slots.DataCreatingActivity_has_part = Slot(
    uri=DCTERMS.hasPart,
    name="DataCreatingActivity_has_part",
    curie=DCTERMS.curie("hasPart"),
    model_uri=NFDI4C.DataCreatingActivity_has_part,
    domain=DataCreatingActivity,
    range=Optional[Union[dict, Activity]],
)

slots.DataCreatingActivity_other_identifier = Slot(
    uri=ADMS.identifier,
    name="DataCreatingActivity_other_identifier",
    curie=ADMS.curie("identifier"),
    model_uri=NFDI4C.DataCreatingActivity_other_identifier,
    domain=DataCreatingActivity,
...
slots.DataAnalysis_evaluated_entity = Slot(
    ...
    curie=PROV.curie("used"),
    model_uri=NFDI4C.DataAnalysis_evaluated_entity,
    domain=DataAnalysis,
    range=Optional[
        Union[
            Dict[Union[str, AnalysisSourceDataId], Union[dict, AnalysisSourceData]],
...
slots.EvaluatedEntity_other_identifier = Slot(
    ...
    curie=ADMS.curie("identifier"),
    model_uri=NFDI4C.EvaluatedEntity_other_identifier,
...
slots.EvaluatedEntity_was_generated_by = Slot(
    ...
    curie=PROV.curie("wasGeneratedBy"),
    model_uri=NFDI4C.EvaluatedEntity_was_generated_by,
    domain=EvaluatedEntity,
    range=Optional[Union[Union[dict, "Activity"], List[Union[dict, "Activity"]]]],
)

slots.EvaluatedEntity_has_part = Slot(
    uri=DCTERMS.hasPart,
    name="EvaluatedEntity_has_part",
    curie=DCTERMS.curie("hasPart"),
    model_uri=NFDI4C.EvaluatedEntity_has_part,
    domain=EvaluatedEntity,
    range=Optional[Union[str, EvaluatedEntityId]],
)
...
slots.AnalysisSourceData_was_generated_by = Slot(
    ...
    curie=PROV.curie("wasGeneratedBy"),
    model_uri=NFDI4C.AnalysisSourceData_was_generated_by,
...
slots.EvaluatedActivity_other_identifier = Slot(
    ...
    curie=ADMS.curie("identifier"),
    model_uri=NFDI4C.EvaluatedActivity_other_identifier,
    domain=EvaluatedActivity,
    range=Optional[Union[Union[dict, "Identifier"], List[Union[dict, "Identifier"]]]],
)

slots.EvaluatedActivity_has_part = Slot(
    uri=DCTERMS.hasPart,
    name="EvaluatedActivity_has_part",
    curie=DCTERMS.curie("hasPart"),
    model_uri=NFDI4C.EvaluatedActivity_has_part,
    domain=EvaluatedActivity,
    range=Optional[Union[str, EvaluatedActivityId]],
)

slots.Tool_has_part = Slot(
    uri=DCTERMS.hasPart,
    name="Tool_has_part",
    curie=DCTERMS.curie("hasPart"),
    model_uri=NFDI4C.Tool_has_part,
    domain=Tool,
    range=Optional[Union[Union[dict, "Tool"], List[Union[dict, "Tool"]]]],
)

slots.Tool_other_identifier = Slot(
    uri=ADMS.identifier,
    name="Tool_other_identifier",
    curie=ADMS.curie("identifier"),
    model_uri=NFDI4C.Tool_other_identifier,
    domain=Tool,
    range=Optional[Union[Union[dict, "Identifier"], List[Union[dict, "Identifier"]]]],
)

slots.Environment_other_identifier = Slot(
    uri=ADMS.identifier,
    name="Environment_other_identifier",
    curie=ADMS.curie("identifier"),
    model_uri=NFDI4C.Environment_other_identifier,
    domain=Environment,
    range=Optional[Union[Union[dict, "Identifier"], List[Union[dict, "Identifier"]]]],
)
...
slots.QualitativeAttribute_value = Slot(
    ...
    curie=PROV.curie("value"),
    model_uri=NFDI4C.QualitativeAttribute_value,
...
slots.QuantitativeAttribute_value = Slot(
    ...
    curie=PROV.curie("value"),
    model_uri=NFDI4C.QuantitativeAttribute_value,
...
slots.Catalogue_applicable_legislation = Slot(
    ...
    curie=DCATAP.curie("applicableLegislation"),
    model_uri=NFDI4C.Catalogue_applicable_legislation,
    domain=Catalogue,
    range=Optional[
        Union[Union[dict, "LegalResource"], List[Union[dict, "LegalResource"]]]
    ],
...
slots.Catalogue_catalogue = Slot(
    ...
    curie=DCAT.curie("catalog"),
    model_uri=NFDI4C.Catalogue_catalogue,
    domain=Catalogue,
...
slots.Catalogue_creator = Slot(
    ...
    curie=DCTERMS.curie("creator"),
    model_uri=NFDI4C.Catalogue_creator,
    domain=Catalogue,
...
slots.Catalogue_description = Slot(
    ...
    curie=DCTERMS.curie("description"),
    model_uri=NFDI4C.Catalogue_description,
    domain=Catalogue,
    range=Union[str, List[str]],
)
...
slots.Catalogue_geographical_coverage = Slot(
    ...
    curie=DCTERMS.curie("spatial"),
    model_uri=NFDI4C.Catalogue_geographical_coverage,
    domain=Catalogue,
...
slots.Catalogue_has_dataset = Slot(
    ...
    curie=DCAT.curie("dataset"),
    model_uri=NFDI4C.Catalogue_has_dataset,
    domain=Catalogue,
...
slots.Catalogue_has_part = Slot(
    ...
    curie=DCTERMS.curie("hasPart"),
    model_uri=NFDI4C.Catalogue_has_part,
    domain=Catalogue,
    range=Optional[Union[Union[dict, "Catalogue"], List[Union[dict, "Catalogue"]]]],
)
...
slots.Catalogue_homepage = Slot(
    ...
    curie=FOAF.curie("homepage"),
    model_uri=NFDI4C.Catalogue_homepage,
    domain=Catalogue,
...
slots.Catalogue_language = Slot(
    ...
    curie=DCTERMS.curie("language"),
    model_uri=NFDI4C.Catalogue_language,
    domain=Catalogue,
    range=Optional[
        Union[Union[dict, "LinguisticSystem"], List[Union[dict, "LinguisticSystem"]]]
    ],
...
slots.Catalogue_licence = Slot(
    ...
    curie=DCTERMS.curie("license"),
    model_uri=NFDI4C.Catalogue_licence,
    domain=Catalogue,
...
slots.Catalogue_modification_date = Slot(
    ...
    curie=DCTERMS.curie("modified"),
    model_uri=NFDI4C.Catalogue_modification_date,
    domain=Catalogue,
...
slots.Catalogue_publisher = Slot(
    ...
    curie=DCTERMS.curie("publisher"),
    model_uri=NFDI4C.Catalogue_publisher,
    domain=Catalogue,
...
slots.Catalogue_record = Slot(
    ...
    curie=DCAT.curie("record"),
    model_uri=NFDI4C.Catalogue_record,
    domain=Catalogue,
    range=Optional[
        Union[Union[dict, "CatalogueRecord"], List[Union[dict, "CatalogueRecord"]]]
    ],
...
slots.Catalogue_release_date = Slot(
    ...
    curie=DCTERMS.curie("issued"),
    model_uri=NFDI4C.Catalogue_release_date,
    domain=Catalogue,
    range=Optional[Union[str, XSDDate]],
)
...
slots.Catalogue_rights = Slot(
    ...
    curie=DCTERMS.curie("rights"),
    model_uri=NFDI4C.Catalogue_rights,
    domain=Catalogue,
...
slots.Catalogue_service = Slot(
    ...
    curie=DCAT.curie("service"),
    model_uri=NFDI4C.Catalogue_service,
    domain=Catalogue,
...
slots.Catalogue_temporal_coverage = Slot(
    ...
    curie=DCTERMS.curie("temporal"),
    model_uri=NFDI4C.Catalogue_temporal_coverage,
    domain=Catalogue,
    range=Optional[
        Union[Union[dict, "PeriodOfTime"], List[Union[dict, "PeriodOfTime"]]]
    ],
...
slots.Catalogue_themes = Slot(
    ...
    curie=DCAT.curie("themeTaxonomy"),
    model_uri=NFDI4C.Catalogue_themes,
    domain=Catalogue,
    range=Optional[
        Union[Union[dict, "ConceptScheme"], List[Union[dict, "ConceptScheme"]]]
    ],
...
slots.Catalogue_title = Slot(
    ...
    curie=DCTERMS.curie("title"),
    model_uri=NFDI4C.Catalogue_title,
    domain=Catalogue,
    range=Union[str, List[str]],
)
...
slots.CatalogueRecord_application_profile = Slot(
    ...
    curie=DCTERMS.curie("conformsTo"),
    model_uri=NFDI4C.CatalogueRecord_application_profile,
...
slots.CatalogueRecord_change_type = Slot(
    ...
    curie=ADMS.curie("status"),
    model_uri=NFDI4C.CatalogueRecord_change_type,
    domain=CatalogueRecord,
    range=Optional[Union[dict, "Concept"]],
)
...
slots.CatalogueRecord_description = Slot(
    ...
    curie=DCTERMS.curie("description"),
    model_uri=NFDI4C.CatalogueRecord_description,
    domain=CatalogueRecord,
...
slots.CatalogueRecord_language = Slot(
    ...
    curie=DCTERMS.curie("language"),
    model_uri=NFDI4C.CatalogueRecord_language,
    domain=CatalogueRecord,
    range=Optional[
        Union[Union[dict, "LinguisticSystem"], List[Union[dict, "LinguisticSystem"]]]
    ],
...
slots.CatalogueRecord_listing_date = Slot(
    ...
    curie=DCTERMS.curie("issued"),
    model_uri=NFDI4C.CatalogueRecord_listing_date,
    domain=CatalogueRecord,
    range=Optional[Union[str, XSDDate]],
)
...
slots.CatalogueRecord_modification_date = Slot(
    ...
    curie=DCTERMS.curie("modified"),
    model_uri=NFDI4C.CatalogueRecord_modification_date,
    domain=CatalogueRecord,
...
slots.CatalogueRecord_primary_topic = Slot(
    ...
    curie=FOAF.curie("primaryTopic"),
    model_uri=NFDI4C.CatalogueRecord_primary_topic,
    domain=CatalogueRecord,
...
slots.CatalogueRecord_source_metadata = Slot(
    ...
    curie=DCTERMS.curie("source"),
    model_uri=NFDI4C.CatalogueRecord_source_metadata,
    domain=CatalogueRecord,
...
slots.CatalogueRecord_title = Slot(
    ...
    curie=DCTERMS.curie("title"),
    model_uri=NFDI4C.CatalogueRecord_title,
    domain=CatalogueRecord,
    range=Optional[Union[str, List[str]]],
)
...
slots.Checksum_algorithm = Slot(
    ...
    curie=SPDX.curie("algorithm"),
    model_uri=NFDI4C.Checksum_algorithm,
    domain=Checksum,
...
slots.Checksum_checksum_value = Slot(
    ...
    curie=SPDX.curie("checksumValue"),
    model_uri=NFDI4C.Checksum_checksum_value,
    domain=Checksum,
    range=str,
)
...
slots.Concept_preferred_label = Slot(
    ...
    curie=SKOS.curie("prefLabel"),
    model_uri=NFDI4C.Concept_preferred_label,
    domain=Concept,
    range=Union[str, List[str]],
)
...
slots.ConceptScheme_title = Slot(
    ...
    curie=DCTERMS.curie("title"),
    model_uri=NFDI4C.ConceptScheme_title,
...
slots.DataService_access_rights = Slot(
    ...
    curie=DCTERMS.curie("accessRights"),
    model_uri=NFDI4C.DataService_access_rights,
    domain=DataService,
    range=Optional[Union[dict, "RightsStatement"]],
)
...
slots.DataService_applicable_legislation = Slot(
    ...
    curie=DCATAP.curie("applicableLegislation"),
    model_uri=NFDI4C.DataService_applicable_legislation,
    domain=DataService,
    range=Optional[
        Union[Union[dict, "LegalResource"], List[Union[dict, "LegalResource"]]]
    ],
...
slots.DataService_conforms_to = Slot(
    ...
    curie=DCTERMS.curie("conformsTo"),
    model_uri=NFDI4C.DataService_conforms_to,
    domain=DataService,
    range=Optional[Union[Union[dict, "Standard"], List[Union[dict, "Standard"]]]],
)
...
slots.DataService_contact_point = Slot(
    ...
    curie=DCAT.curie("contactPoint"),
    model_uri=NFDI4C.DataService_contact_point,
    domain=DataService,
...
slots.DataService_description = Slot(
    ...
    curie=DCTERMS.curie("description"),
    model_uri=NFDI4C.DataService_description,
    domain=DataService,
    range=Optional[Union[str, List[str]]],
)
...
slots.DataService_documentation = Slot(
    ...
    curie=FOAF.curie("page"),
    model_uri=NFDI4C.DataService_documentation,
    domain=DataService,
    range=Optional[Union[Union[dict, "Document"], List[Union[dict, "Document"]]]],
)
...
slots.DataService_endpoint_URL = Slot(
    ...
    curie=DCAT.curie("endpointURL"),
    model_uri=NFDI4C.DataService_endpoint_URL,
    domain=DataService,
...
slots.DataService_endpoint_description = Slot(
    ...
    curie=DCAT.curie("endpointDescription"),
    model_uri=NFDI4C.DataService_endpoint_description,
    domain=DataService,
...
slots.DataService_format = Slot(
    ...
    curie=DCTERMS.curie("format"),
    model_uri=NFDI4C.DataService_format,
    domain=DataService,
    range=Optional[
        Union[Union[dict, "MediaTypeOrExtent"], List[Union[dict, "MediaTypeOrExtent"]]]
    ],
...
slots.DataService_keyword = Slot(
    ...
    curie=DCAT.curie("keyword"),
    model_uri=NFDI4C.DataService_keyword,
    domain=DataService,
    range=Optional[Union[str, List[str]]],
)
...
slots.DataService_landing_page = Slot(
    ...
    curie=DCAT.curie("landingPage"),
    model_uri=NFDI4C.DataService_landing_page,
    domain=DataService,
    range=Optional[Union[Union[dict, "Document"], List[Union[dict, "Document"]]]],
)
...
slots.DataService_licence = Slot(
    ...
    curie=DCTERMS.curie("license"),
    model_uri=NFDI4C.DataService_licence,
    domain=DataService,
    range=Optional[Union[dict, "LicenseDocument"]],
)
...
slots.DataService_publisher = Slot(
    ...
    curie=DCTERMS.curie("publisher"),
    model_uri=NFDI4C.DataService_publisher,
    domain=DataService,
    range=Optional[Union[dict, "Agent"]],
)
...
slots.DataService_serves_dataset = Slot(
    ...
    curie=DCAT.curie("servesDataset"),
    model_uri=NFDI4C.DataService_serves_dataset,
    domain=DataService,
    range=Optional[Union[Union[dict, "Dataset"], List[Union[dict, "Dataset"]]]],
)
...
slots.DataService_theme = Slot(
    ...
    curie=DCAT.curie("theme"),
    model_uri=NFDI4C.DataService_theme,
    domain=DataService,
...
slots.DataService_title = Slot(
    ...
    curie=DCTERMS.curie("title"),
    model_uri=NFDI4C.DataService_title,
    domain=DataService,
    range=Union[str, List[str]],
)
...
slots.Dataset_access_rights = Slot(
    ...
    curie=DCTERMS.curie("accessRights"),
    model_uri=NFDI4C.Dataset_access_rights,
    domain=Dataset,
    range=Optional[Union[dict, "RightsStatement"]],
)
...
slots.Dataset_applicable_legislation = Slot(
    ...
    curie=DCATAP.curie("applicableLegislation"),
    model_uri=NFDI4C.Dataset_applicable_legislation,
    domain=Dataset,
    range=Optional[
        Union[Union[dict, "LegalResource"], List[Union[dict, "LegalResource"]]]
    ],
...
slots.Dataset_conforms_to = Slot(
    ...
    curie=DCTERMS.curie("conformsTo"),
    model_uri=NFDI4C.Dataset_conforms_to,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Standard"], List[Union[dict, "Standard"]]]],
)
...
slots.Dataset_contact_point = Slot(
    ...
    curie=DCAT.curie("contactPoint"),
    model_uri=NFDI4C.Dataset_contact_point,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Kind"], List[Union[dict, "Kind"]]]],
)
...
slots.Dataset_creator = Slot(
    ...
    curie=DCTERMS.curie("creator"),
    model_uri=NFDI4C.Dataset_creator,
    domain=Dataset,
...
slots.Dataset_dataset_distribution = Slot(
    ...
    curie=DCAT.curie("distribution"),
    model_uri=NFDI4C.Dataset_dataset_distribution,
    domain=Dataset,
    range=Optional[
        Union[Union[dict, "Distribution"], List[Union[dict, "Distribution"]]]
    ],
...
slots.Dataset_description = Slot(
    ...
    curie=DCTERMS.curie("description"),
    model_uri=NFDI4C.Dataset_description,
    domain=Dataset,
    range=Union[str, List[str]],
)
...
slots.Dataset_documentation = Slot(
    ...
    curie=FOAF.curie("page"),
    model_uri=NFDI4C.Dataset_documentation,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Document"], List[Union[dict, "Document"]]]],
)
...
slots.Dataset_frequency = Slot(
    ...
    curie=DCTERMS.curie("accrualPeriodicity"),
    model_uri=NFDI4C.Dataset_frequency,
    domain=Dataset,
...
slots.Dataset_geographical_coverage = Slot(
    ...
    curie=DCTERMS.curie("spatial"),
    model_uri=NFDI4C.Dataset_geographical_coverage,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Location"], List[Union[dict, "Location"]]]],
)
...
slots.Dataset_has_version = Slot(
    ...
    curie=DCAT.curie("hasVersion"),
    model_uri=NFDI4C.Dataset_has_version,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Dataset"], List[Union[dict, "Dataset"]]]],
)
...
slots.Dataset_identifier = Slot(
    ...
    curie=DCTERMS.curie("identifier"),
    model_uri=NFDI4C.Dataset_identifier,
    domain=Dataset,
    range=Optional[Union[str, List[str]]],
)
...
slots.Dataset_in_series = Slot(
    ...
    curie=DCAT.curie("inSeries"),
    model_uri=NFDI4C.Dataset_in_series,
    domain=Dataset,
    range=Optional[
        Union[Union[dict, "DatasetSeries"], List[Union[dict, "DatasetSeries"]]]
    ],
...
slots.Dataset_is_referenced_by = Slot(
    ...
    curie=DCTERMS.curie("isReferencedBy"),
    model_uri=NFDI4C.Dataset_is_referenced_by,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Resource"], List[Union[dict, "Resource"]]]],
)
...
slots.Dataset_keyword = Slot(
    ...
    curie=DCAT.curie("keyword"),
    model_uri=NFDI4C.Dataset_keyword,
    domain=Dataset,
    range=Optional[Union[str, List[str]]],
)
...
slots.Dataset_landing_page = Slot(
    ...
    curie=DCAT.curie("landingPage"),
    model_uri=NFDI4C.Dataset_landing_page,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Document"], List[Union[dict, "Document"]]]],
)
...
slots.Dataset_language = Slot(
    ...
    curie=DCTERMS.curie("language"),
    model_uri=NFDI4C.Dataset_language,
    domain=Dataset,
    range=Optional[
        Union[Union[dict, "LinguisticSystem"], List[Union[dict, "LinguisticSystem"]]]
    ],
...
slots.Dataset_modification_date = Slot(
    ...
    curie=DCTERMS.curie("modified"),
    model_uri=NFDI4C.Dataset_modification_date,
    domain=Dataset,
    range=Optional[Union[str, XSDDate]],
)
...
slots.Dataset_other_identifier = Slot(
    ...
    curie=ADMS.curie("identifier"),
    model_uri=NFDI4C.Dataset_other_identifier,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Identifier"], List[Union[dict, "Identifier"]]]],
)
...
slots.Dataset_provenance = Slot(
    ...
    curie=DCTERMS.curie("provenance"),
    model_uri=NFDI4C.Dataset_provenance,
    domain=Dataset,
    range=Optional[
        Union[
            Union[dict, "ProvenanceStatement"], List[Union[dict, "ProvenanceStatement"]]
...
slots.Dataset_publisher = Slot(
    ...
    curie=DCTERMS.curie("publisher"),
    model_uri=NFDI4C.Dataset_publisher,
    domain=Dataset,
    range=Optional[Union[dict, "Agent"]],
)
...
slots.Dataset_qualified_attribution = Slot(
    ...
    curie=PROV.curie("qualifiedAttribution"),
    model_uri=NFDI4C.Dataset_qualified_attribution,
    domain=Dataset,
...
slots.Dataset_qualified_relation = Slot(
    ...
    curie=DCAT.curie("qualifiedRelation"),
    model_uri=NFDI4C.Dataset_qualified_relation,
    domain=Dataset,
    range=Optional[
        Union[Union[dict, "Relationship"], List[Union[dict, "Relationship"]]]
    ],
...
slots.Dataset_related_resource = Slot(
    ...
    curie=DCTERMS.curie("relation"),
    model_uri=NFDI4C.Dataset_related_resource,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Resource"], List[Union[dict, "Resource"]]]],
)
...
slots.Dataset_release_date = Slot(
    ...
    curie=DCTERMS.curie("issued"),
    model_uri=NFDI4C.Dataset_release_date,
    domain=Dataset,
    range=Optional[Union[str, XSDDate]],
)
...
slots.Dataset_sample = Slot(
    ...
    name="Dataset_sample",
    curie=ADMS.curie("sample"),
    model_uri=NFDI4C.Dataset_sample,
    domain=Dataset,
    range=Optional[
        Union[Union[dict, "Distribution"], List[Union[dict, "Distribution"]]]
    ],
...
slots.Dataset_source = Slot(
    ...
    name="Dataset_source",
    curie=DCTERMS.curie("source"),
    model_uri=NFDI4C.Dataset_source,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Dataset"], List[Union[dict, "Dataset"]]]],
)
...
slots.Dataset_spatial_resolution = Slot(
    ...
    curie=DCAT.curie("spatialResolutionInMeters"),
    model_uri=NFDI4C.Dataset_spatial_resolution,
    domain=Dataset,
...
slots.Dataset_temporal_coverage = Slot(
    ...
    curie=DCTERMS.curie("temporal"),
    model_uri=NFDI4C.Dataset_temporal_coverage,
    domain=Dataset,
    range=Optional[
        Union[Union[dict, "PeriodOfTime"], List[Union[dict, "PeriodOfTime"]]]
    ],
...
slots.Dataset_temporal_resolution = Slot(
    ...
    curie=DCAT.curie("temporalResolution"),
    model_uri=NFDI4C.Dataset_temporal_resolution,
    domain=Dataset,
    range=Optional[str],
)
...
slots.Dataset_theme = Slot(
    ...
    name="Dataset_theme",
    curie=DCAT.curie("theme"),
    model_uri=NFDI4C.Dataset_theme,
    domain=Dataset,
    range=Optional[Union[Union[dict, "Concept"], List[Union[dict, "Concept"]]]],
)
...
slots.Dataset_title = Slot(
    ...
    name="Dataset_title",
    curie=DCTERMS.curie("title"),
    model_uri=NFDI4C.Dataset_title,
    domain=Dataset,
    range=Union[str, List[str]],
)
...
slots.Dataset_version = Slot(
    ...
    curie=DCAT.curie("version"),
    model_uri=NFDI4C.Dataset_version,
    domain=Dataset,
    range=Optional[str],
)
...
slots.Dataset_version_notes = Slot(
    ...
    curie=ADMS.curie("versionNotes"),
    model_uri=NFDI4C.Dataset_version_notes,
    domain=Dataset,
    range=Optional[Union[str, List[str]]],
)
...
slots.Dataset_was_generated_by = Slot(
    ...
    curie=PROV.curie("wasGeneratedBy"),
    model_uri=NFDI4C.Dataset_was_generated_by,
    domain=Dataset,
    range=Optional[Union[Union[dict, Activity], List[Union[dict, Activity]]]],
)
...
slots.DatasetSeries_applicable_legislation = Slot(
    ...
    curie=DCATAP.curie("applicableLegislation"),
    model_uri=NFDI4C.DatasetSeries_applicable_legislation,
...
slots.DatasetSeries_contact_point = Slot(
    ...
    curie=DCAT.curie("contactPoint"),
    model_uri=NFDI4C.DatasetSeries_contact_point,
    domain=DatasetSeries,
    range=Optional[Union[Union[dict, "Kind"], List[Union[dict, "Kind"]]]],
)
...
slots.DatasetSeries_description = Slot(
    ...
    curie=DCTERMS.curie("description"),
    model_uri=NFDI4C.DatasetSeries_description,
    domain=DatasetSeries,
    range=Union[str, List[str]],
)
...
slots.DatasetSeries_frequency = Slot(
    ...
    curie=DCTERMS.curie("accrualPeriodicity"),
    model_uri=NFDI4C.DatasetSeries_frequency,
    domain=DatasetSeries,
    range=Optional[Union[dict, "Frequency"]],
)
...
slots.DatasetSeries_geographical_coverage = Slot(
    ...
    curie=DCTERMS.curie("spatial"),
    model_uri=NFDI4C.DatasetSeries_geographical_coverage,
    domain=DatasetSeries,
    range=Optional[Union[Union[dict, "Location"], List[Union[dict, "Location"]]]],
)
...
slots.DatasetSeries_modification_date = Slot(
    ...
    curie=DCTERMS.curie("modified"),
    model_uri=NFDI4C.DatasetSeries_modification_date,
    domain=DatasetSeries,
    range=Optional[Union[str, XSDDate]],
)
...
slots.DatasetSeries_publisher = Slot(
    ...
    curie=DCTERMS.curie("publisher"),
    model_uri=NFDI4C.DatasetSeries_publisher,
    domain=DatasetSeries,
    range=Optional[Union[dict, "Agent"]],
)
...
slots.DatasetSeries_release_date = Slot(
    ...
    curie=DCTERMS.curie("issued"),
    model_uri=NFDI4C.DatasetSeries_release_date,
    domain=DatasetSeries,
    range=Optional[Union[str, XSDDate]],
)
...
slots.DatasetSeries_temporal_coverage = Slot(
    ...
    curie=DCTERMS.curie("temporal"),
    model_uri=NFDI4C.DatasetSeries_temporal_coverage,
    domain=DatasetSeries,
    range=Optional[
        Union[Union[dict, "PeriodOfTime"], List[Union[dict, "PeriodOfTime"]]]
    ],
...
slots.DatasetSeries_title = Slot(
    ...
    curie=DCTERMS.curie("title"),
    model_uri=NFDI4C.DatasetSeries_title,
    domain=DatasetSeries,
    range=Union[str, List[str]],
)
...
slots.Distribution_access_URL = Slot(
    ...
    curie=DCAT.curie("accessURL"),
    model_uri=NFDI4C.Distribution_access_URL,
    domain=Distribution,
    range=Union[Union[dict, "Resource"], List[Union[dict, "Resource"]]],
)
...
slots.Distribution_access_service = Slot(
    ...
    curie=DCAT.curie("accessService"),
    model_uri=NFDI4C.Distribution_access_service,
    domain=Distribution,
    range=Optional[Union[Union[dict, DataService], List[Union[dict, DataService]]]],
)
...
slots.Distribution_applicable_legislation = Slot(
    ...
    curie=DCATAP.curie("applicableLegislation"),
    model_uri=NFDI4C.Distribution_applicable_legislation,
    domain=Distribution,
    range=Optional[
        Union[Union[dict, "LegalResource"], List[Union[dict, "LegalResource"]]]
    ],
...
slots.Distribution_availability = Slot(
    ...
    curie=DCATAP.curie("availability"),
    model_uri=NFDI4C.Distribution_availability,
    domain=Distribution,
    range=Optional[Union[dict, "Concept"]],
)
...
slots.Distribution_byte_size = Slot(
    ...
    curie=DCAT.curie("byteSize"),
    model_uri=NFDI4C.Distribution_byte_size,
    domain=Distribution,
    range=Optional[int],
)
...
slots.Distribution_checksum = Slot(
    ...
    curie=SPDX.curie("checksum"),
    model_uri=NFDI4C.Distribution_checksum,
    domain=Distribution,
...
slots.Distribution_compression_format = Slot(
    ...
    curie=DCAT.curie("compressFormat"),
    model_uri=NFDI4C.Distribution_compression_format,
    domain=Distribution,
...
slots.Distribution_description = Slot(
    ...
    curie=DCTERMS.curie("description"),
    model_uri=NFDI4C.Distribution_description,
    domain=Distribution,
    range=Optional[Union[str, List[str]]],
)
...
slots.Distribution_documentation = Slot(
    ...
    curie=FOAF.curie("page"),
    model_uri=NFDI4C.Distribution_documentation,
    domain=Distribution,
    range=Optional[Union[Union[dict, "Document"], List[Union[dict, "Document"]]]],
)
...
slots.Distribution_download_URL = Slot(
    ...
    curie=DCAT.curie("downloadURL"),
    model_uri=NFDI4C.Distribution_download_URL,
    domain=Distribution,
    range=Optional[Union[Union[dict, "Resource"], List[Union[dict, "Resource"]]]],
)
...
slots.Distribution_format = Slot(
    ...
    curie=DCTERMS.curie("format"),
    model_uri=NFDI4C.Distribution_format,
    domain=Distribution,
...
slots.Distribution_has_policy = Slot(
    ...
    curie=ODRL.curie("hasPolicy"),
    model_uri=NFDI4C.Distribution_has_policy,
    domain=Distribution,
...
slots.Distribution_language = Slot(
    ...
    curie=DCTERMS.curie("language"),
    model_uri=NFDI4C.Distribution_language,
    domain=Distribution,
    range=Optional[
        Union[Union[dict, "LinguisticSystem"], List[Union[dict, "LinguisticSystem"]]]
    ],
...
slots.Distribution_licence = Slot(
    ...
    curie=DCTERMS.curie("license"),
    model_uri=NFDI4C.Distribution_licence,
    domain=Distribution,
    range=Optional[Union[dict, "LicenseDocument"]],
)
...
slots.Distribution_linked_schemas = Slot(
    ...
    curie=DCTERMS.curie("conformsTo"),
    model_uri=NFDI4C.Distribution_linked_schemas,
    domain=Distribution,
    range=Optional[Union[Union[dict, "Standard"], List[Union[dict, "Standard"]]]],
)
...
slots.Distribution_media_type = Slot(
    ...
    curie=DCAT.curie("mediaType"),
    model_uri=NFDI4C.Distribution_media_type,
    domain=Distribution,
    range=Optional[Union[dict, "MediaType"]],
)
...
slots.Distribution_modification_date = Slot(
    ...
    curie=DCTERMS.curie("modified"),
    model_uri=NFDI4C.Distribution_modification_date,
    domain=Distribution,
    range=Optional[Union[str, XSDDate]],
)
...
slots.Distribution_packaging_format = Slot(
    ...
    curie=DCAT.curie("packageFormat"),
    model_uri=NFDI4C.Distribution_packaging_format,
    domain=Distribution,
    range=Optional[Union[dict, "MediaType"]],
)
...
slots.Distribution_release_date = Slot(
    ...
    curie=DCTERMS.curie("issued"),
    model_uri=NFDI4C.Distribution_release_date,
    domain=Distribution,
    range=Optional[Union[str, XSDDate]],
)
...
slots.Distribution_rights = Slot(
    ...
    curie=DCTERMS.curie("rights"),
    model_uri=NFDI4C.Distribution_rights,
    domain=Distribution,
    range=Optional[Union[dict, "RightsStatement"]],
)
...
slots.Distribution_spatial_resolution = Slot(
    ...
    curie=DCAT.curie("spatialResolutionInMeters"),
    model_uri=NFDI4C.Distribution_spatial_resolution,
    domain=Distribution,
    range=Optional[Decimal],
)
...
slots.Distribution_status = Slot(
    ...
    curie=ADMS.curie("status"),
    model_uri=NFDI4C.Distribution_status,
    domain=Distribution,
    range=Optional[Union[dict, "Concept"]],
)
...
slots.Distribution_temporal_resolution = Slot(
    ...
    curie=DCAT.curie("temporalResolution"),
    model_uri=NFDI4C.Distribution_temporal_resolution,
    domain=Distribution,
    range=Optional[str],
)
...
slots.Distribution_title = Slot(
    ...
    curie=DCTERMS.curie("title"),
    model_uri=NFDI4C.Distribution_title,
    domain=Distribution,
    range=Optional[Union[str, List[str]]],
)
...
slots.Identifier_notation = Slot(
    ...
    curie=SKOS.curie("notation"),
    model_uri=NFDI4C.Identifier_notation,
    domain=Identifier,
    range=str,
)
...
slots.LicenseDocument_type = Slot(
    ...
    curie=DCTERMS.curie("type"),
    model_uri=NFDI4C.LicenseDocument_type,
...
slots.Location_bbox = Slot(
    ...
    name="Location_bbox",
    curie=DCAT.curie("bbox"),
    model_uri=NFDI4C.Location_bbox,
    domain=Location,
    range=Optional[str],
)
...
slots.Location_centroid = Slot(
    ...
    curie=DCAT.curie("centroid"),
    model_uri=NFDI4C.Location_centroid,
    domain=Location,
    range=Optional[str],
)
...
slots.Location_geometry = Slot(
    ...
    curie=LOCN.curie("geometry"),
    model_uri=NFDI4C.Location_geometry,
    domain=Location,
...
slots.PeriodOfTime_beginning = Slot(
    ...
    curie=TIME.curie("hasBeginning"),
    model_uri=NFDI4C.PeriodOfTime_beginning,
    domain=PeriodOfTime,
...
slots.PeriodOfTime_end = Slot(
    ...
    curie=TIME.curie("hasEnd"),
    model_uri=NFDI4C.PeriodOfTime_end,
    domain=PeriodOfTime,
    range=Optional[Union[dict, "TimeInstant"]],
)
...
slots.PeriodOfTime_end_date = Slot(
    ...
    curie=DCAT.curie("endDate"),
    model_uri=NFDI4C.PeriodOfTime_end_date,
    domain=PeriodOfTime,
    range=Optional[str],
)
...
slots.PeriodOfTime_start_date = Slot(
    ...
    curie=DCAT.curie("startDate"),
    model_uri=NFDI4C.PeriodOfTime_start_date,
    domain=PeriodOfTime,
    range=Optional[str],
)
...
slots.Relationship_had_role = Slot(
    ...
    curie=DCAT.curie("hadRole"),
    model_uri=NFDI4C.Relationship_had_role,
    domain=Relationship,
...
slots.Relationship_relation = Slot(
    ...
    curie=DCTERMS.curie("relation"),
    model_uri=NFDI4C.Relationship_relation,
    domain=Relationship,
    range=Union[Union[dict, "Resource"], List[Union[dict, "Resource"]]],
)

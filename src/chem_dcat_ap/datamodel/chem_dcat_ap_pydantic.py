...
class ChemicalSubstanceMixin(ConfiguredBaseModel):
    """
...
class DissolvingSubstance(MaterialisticMixin, ChemicalSubstanceMixin, AgenticEntity):
    """
...
class Catalyst(MaterialisticMixin, ChemicalSubstanceMixin, AgenticEntity):
    """

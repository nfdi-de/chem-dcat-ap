...
process that generated a `dcat:Dataset`.

ChemDCAT-AP is designed to provide chemistry and catalysis-specific metadata for the chemical substances, reactions and 
analyses covered by a dataset in a more user-friendly way than DCAT-AP+. This is achieved by introducing specialized 
...
- Schema elements are already mapped to chemistry and catalysis related ontologies (e.g., ChEBI, CHEMINF, CHMO and RXNO)

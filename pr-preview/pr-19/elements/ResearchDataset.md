...
| [describes_entity](describes_entity.md) | * _recommended_ <br/> [EvaluatedEntity](EvaluatedEntity.md) | A slot to provide the EvaluatedEntity that is described by a Dataset | direct |
| [describes_activity](describes_activity.md) | * _recommended_ <br/> [EvaluatedActivity](EvaluatedActivity.md) | A slot to provide the EvaluatedActivity that is described by a Dataset | direct |
